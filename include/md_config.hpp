...
struct MDConfig {
  ...
  // ABP (Active Brownian Particle) parameters
  double mu = 1.0;      // Mobility coefficient (force to velocity conversion)
  double v0 = 0.0;      // Self-propulsion speed
...
public:
  ...
  static bool parse_override_argument(const std::string &argument,
                                      std::string &out_key,
