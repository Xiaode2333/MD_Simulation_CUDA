#!/usr/bin/env python3
"""CLI wrapper that renders particle CSV snapshots via matplotlib."""
...
from particle_csv import plot_particle_csv  # type: ignore  # added to sys.path above


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot MD particle CSV snapshots")
    parser.add_argument("--filename", required=True, help="Output image path (PNG)")
    parser.add_argument("--csv_path", required=True, help="Particle CSV path")
