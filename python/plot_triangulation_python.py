#!/usr/bin/env python3
"""CLI wrapper to render triangulation CSV snapshots."""
...
from particle_csv import plot_triangulation_csv  # type: ignore


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot MD triangulation CSV snapshots")
    parser.add_argument("--csv_name", required=True, help="Triangulation CSV path")
