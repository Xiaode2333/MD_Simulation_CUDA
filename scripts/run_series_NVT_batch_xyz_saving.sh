...
#SBATCH --mem=64G
#SBATCH --array=0-5
#SBATCH --output=./results/20260313_NVT_batch_xyz_saving/slurm_%A_%a.out
...
echo "Launching run_series_NVT_batch_xyz_saving for T=${T_VALUE} with base dir '${BASE_DIR}'."
