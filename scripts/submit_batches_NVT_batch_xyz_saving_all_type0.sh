...
BASE_ROOT="./results/20260324_NVT_batch_xyz_saving_all_type0"
...
if [ ! -x "$SERIES_BIN" ]; then
    echo "[INFO] Building target 'run_series_NVT_batch_xyz_saving_piston' in '${BUILD_ROOT}' for commit ${GIT_HASH}."
...
echo "Submitting NVT xyz-saving all-type0 temperature array (T=0.5..1.0) into ${BASE_ROOT}"
